...
#
#    There may, however, be reasons that even the first structure is
#    shared between two or three different structures in the
#    ensemble. Therefore, I have (presently) set up a variety of
#    options for how to analyze the output.
#
...
class Anal:
    ...
    def anal_loops(self, cl):
        ...
        self.range_dG     = cl.ddG_range   # sets either default or set value
